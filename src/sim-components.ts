...
//------------------------------------------------------------------------------
  ...
  export type SIM_Name         = string       // mainly for illustrative reasons
  export type SIM_Path         = string                                  // dto.
  export type SIM_Identifier   = string                                  // dto.
  export type SIM_AttrName     = string                                  // dto.
  export type SIM_Selector     = string                                  // dto.
  export type SIM_Ordinal      = number                                  // dto.
  export type SIM_Cardinal     = number                                  // dto.
  export type SIM_Text         = string                                  // dto.
  export type SIM_Textline     = string                                  // dto.
  export type SIM_Color        = string                                  // dto.
  export type SIM_EMailAddress = string                                  // dto.
  export type SIM_PhoneNumber  = string                                  // dto.
  export type SIM_URL          = string                                  // dto.

/**** geometry-related types ****/

  export type SIM_Location  = number                                     // dto.
  export type SIM_Dimension = number                                     // dto.

  export type SIM_Position = { x:SIM_Location,y:SIM_Location }
  export type SIM_Size     = { Width:SIM_Dimension,Height:SIM_Dimension }

  export type SIM_Geometry = {
    x:SIM_Location,y:SIM_Location, Width:SIM_Dimension,Height:SIM_Dimension
  }

/**** AssetsBase, IconFolder ****/

  const AssetsBase:SIM_URL = '/' // 'https://rozek.github.io/smart-information-manager/'
  const IconFolder:SIM_URL = AssetsBase + 'icons/'
...
/**** ValueIsSpecial ****/
  ...
  export function ValueIsSpecial (Value:any):boolean {
    return (
      (Value === SIM_empty) || (Value === SIM_noSelection) ||
...
/**** allow/expect[ed]Path ****/
  ...
  export const allowPath = ValidatorForClassifier(
    ValueIsPath, acceptNil, 'SIM name path'
  ), allowedPath = allowPath

  export const expectPath = ValidatorForClassifier(
    ValueIsPath, rejectNil, 'SIM name path'
...
/**** allow/expect[ed]Location ****/
  ...
  export const allowLocation = ValidatorForClassifier(
    ValueIsLocation, acceptNil, 'SIM coordinate'
  ), allowedLocation = allowLocation

  export const expectLocation = ValidatorForClassifier(
    ValueIsLocation, rejectNil, 'SIM coordinate'
...
/**** optionalAttribute ****/
  ...
  export function optionalAttribute (
    PropSet:Indexable, PropName:SIM_AttrName, Validator:Function,
    PropSetName?:SIM_Textline
  ):any|undefined {
    expectPlainObject        ('PropSet',PropSet)
...
/**** optional/mandatoryValue ****/
  ...
  export function optionalValue (PropName:SIM_AttrName, Validator:Function):(PropSet:any) => any|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,Validator)
  }

  export function mandatoryValue (PropName:SIM_AttrName, Validator:Function):(PropSet:any) => any {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,Validator)
  }

/**** optional/mandatoryBoolean ****/

  export function optionalBoolean (PropName:SIM_AttrName):(PropSet:any) => boolean|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsBoolean)
  }

  export function mandatoryBoolean (PropName:SIM_AttrName):(PropSet:any) => boolean {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsBoolean)
  }

/**** optional/mandatoryNumber ****/

  export function optionalNumber (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsNumber)
  }

  export function mandatoryNumber (PropName:SIM_AttrName):(PropSet:any) => number {
...
/**** optional/mandatoryNumberInRange ****/
  ...
  export function optionalNumberInRange (
    PropName:SIM_AttrName, Minimum?:number, Maximum?:number,
...
/**** optional/mandatoryInteger ****/
  ...
  export function optionalInteger (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsInteger)
  }

  export function mandatoryInteger (PropName:SIM_AttrName):(PropSet:any) => number {
...
/**** optional/mandatoryOrdinal ****/
  ...
  export function optionalOrdinal (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsOrdinal)
  }

  export function mandatoryOrdinal (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsOrdinal)
  }

/**** optional/mandatoryCardinal ****/

  export function optionalCardinal (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsCardinal)
  }

  export function mandatoryCardinal (PropName:SIM_AttrName):(PropSet:any) => number|undefined {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsCardinal)
  }

/**** optional/mandatoryString ****/

  export function optionalString (PropName:SIM_AttrName):(PropSet:any) => string|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsString)
  }

  export function mandatoryString (PropName:SIM_AttrName):(PropSet:any) => string {
...
/**** optional/mandatoryStringMatching ****/
  ...
  export function optionalStringMatching (
    PropName:SIM_AttrName, Pattern:RegExp
...
/**** optional/mandatoryText ****/
  ...
  export function optionalText (PropName:SIM_AttrName):(PropSet:any) => string|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsText)
  }

  export function mandatoryText (PropName:SIM_AttrName):(PropSet:any) => string {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsText)
  }

/**** optional/mandatoryTextline ****/

  export function optionalTextline (PropName:SIM_AttrName):(PropSet:any) => string|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsTextline)
  }

  export function mandatoryTextline (PropName:SIM_AttrName):(PropSet:any) => string {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsTextline)
  }

/**** optional/mandatoryFunction ****/

  export function optionalFunction (PropName:SIM_AttrName):(PropSet:any) => Function|undefined {
    return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsFunction)
  }

  export function mandatoryFunction (PropName:SIM_AttrName):(PropSet:any) => Function {
    return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsFunction)
  }

  /**** optional/mandatoryColor ****/

    export function optionalColor (PropName:SIM_AttrName):(PropSet:any) => SIM_Color|undefined {
      return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsColor)
    }

    export function mandatoryColor (PropName:SIM_AttrName):(PropSet:any) => SIM_Color {
      return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsColor)
    }

  /**** optional/mandatoryEMailAddress ****/

    export function optionalEMailAddress (PropName:SIM_AttrName):(PropSet:any) => SIM_EMailAddress|undefined {
      return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsEMailAddress)
    }

    export function mandatoryEMailAddress (PropName:SIM_AttrName):(PropSet:any) => SIM_EMailAddress {
      return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsEMailAddress)
    }

  /**** optional/mandatoryPhoneNumber ****/

    export function optionalPhoneNumber (PropName:SIM_AttrName):(PropSet:any) => SIM_PhoneNumber|undefined {
      return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsPhoneNumber)
    }

    export function mandatoryPhoneNumber (PropName:SIM_AttrName):(PropSet:any) => SIM_PhoneNumber {
      return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsPhoneNumber)
    }

  /**** optional/mandatoryURL ****/

    export function optionalURL (PropName:SIM_AttrName):(PropSet:any) => SIM_URL|undefined {
      return (PropSet:any) => optionalAttribute(PropSet,PropName,ValueIsURL)
    }

    export function mandatoryURL (PropName:SIM_AttrName):(PropSet:any) => SIM_URL {
      return (PropSet:any) => mandatoryAttribute(PropSet,PropName,ValueIsURL)
    }

  /**** optional/mandatoryPath ****/

    export function optionalPath (PropName:SIM_AttrName):(PropSet:any) => Function|undefined {
      return (PropSet:any) => optionalAttribute(
        PropSet,PropName,
    ...
    export function mandatoryPath (PropName:SIM_AttrName):(PropSet:any) => Function {
      return (PropSet:any) => mandatoryAttribute(
        PropSet,PropName,
        (Value:any) => ValueIsPath(Value)
      )
  ...
  /**** optional/mandatoryNameOrIndex ****/
    ...
    export function optionalNameOrIndex (PropName:SIM_AttrName):(PropSet:any) => Function|undefined {
      return (PropSet:any) => optionalAttribute(
        PropSet,PropName,
    ...
    export function mandatoryNameOrIndex (PropName:SIM_AttrName):(PropSet:any) => Function {
      return (PropSet:any) => mandatoryAttribute(
        PropSet,PropName,
        (Value:any) => ValueIsName(Value) || ValueIsOrdinal(Value)
      )
...
*/
  ...
  export type SIM_DragHandler = (dx:number,dy:number, x:number,y:number, Event:PointerEvent) => void
  ...
  export function useDragging ({
    ...
    ViewRef:any,
    Container?:SIM_Selector|HTMLElement|Function,
    onlyFrom?: SIM_Selector|HTMLElement,
    neverFrom?:SIM_Selector|HTMLElement,
    onDragStart?:       SIM_DragHandler,
    onDragContinuation?:SIM_DragHandler,
    onDragFinish?:      SIM_DragHandler,
    onDragCancellation?:SIM_DragHandler,
  ...
  /**** matchesSelector ****/
    ...
    function matchesSelector (
      Element:HTMLElement, Selector:SIM_Selector|HTMLElement|undefined
    ):boolean {
      switch (true) {
...
//export type SIM_DragHandler  = (dx:number,dy:number, x:number,y:number, Event:PointerEvent) => void
  export type SIM_ClickHandler = (ClickCount:number, dx:number,dy:number, x:number,y:number, Event:PointerEvent) => void
  ...
  export function useClickDragging ({
    ...
    onlyFrom?: SIM_Selector|HTMLElement,
    neverFrom?:SIM_Selector|HTMLElement,
    ClickRadius?:       SIM_Ordinal,
    MultiClickLimit?:   SIM_Ordinal,
    MultiClickTimeSpan?:SIM_Ordinal,
    onClick?:           SIM_ClickHandler,
    onDragStart?:       SIM_DragHandler,
    onDragContinuation?:SIM_DragHandler,
    onDragFinish?:      SIM_DragHandler,
    onDragCancellation?:SIM_DragHandler,
...
/**** normalizedName ****/
  ...
  export function normalizedName (Name:SIM_Name):SIM_Name {
...
/**** _normalizedName ****/
  ...
  export function _normalizedName (Name:SIM_Name):SIM_Name {
...
/**** normalizedPath ****/
  ...
  export function normalizedPath (Path:SIM_Path):SIM_Path {
...
/**** _normalizedPath ****/
  ...
  export function _normalizedPath (Path:SIM_Path):SIM_Path {
...
/**** installStylesheetFor ****/
  ...
  export function installStylesheetFor (
    Name:SIM_Name, Stylesheet:SIM_Text, overwrite:boolean = false
  ):void {
...
/**** uninstallStylesheetFor ****/
  ...
  export function uninstallStylesheetFor (Name:SIM_Name):void {
    expectPath('stylesheet name',Name)
...
/**** ErrorIndicator ****/
  ...
  export function SIM_ErrorIndicator (PropSet:Indexable):any {
...
/**** fullsized ****/
  ...
  export function fullsized (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component fullsized ${Classes ?? ''}" ...${RestProps}>
        ${ContentList}
      </>`
    })
  }
...
/**** centered ****/
  ...
  export function centered (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component centered ${Classes ?? ''}" ...${RestProps}>
        ${ContentList}
      </>`
    })
  }
...
/**** horizontal ****/
  ...
  export function horizontal (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component horizontal ${Classes ?? ''}"
...
/**** vertical ****/
  ...
  export function vertical (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component vertical ${Classes ?? ''}"
        style="gap:${Gap}px; ${Style ?? ''}" ...${RestProps}
      >${ContentList}</>`
    })
  }
...
/**** tabular (column classes may be "expanding" or "shrinking", see below) ****/
  ...
  export function tabular (PropSet:Indexable):any {
    ...
    /**** prepare for explicit ColSpans ****/
      ...
      function ColSpanOfCell (TableCell:VNode):SIM_Ordinal {
    ...
    /**** now render the whole table ****/
      ...
      return html`<table class="sim-component tabular ${Classes ?? ''}" style="
        ${Style ?? ''};
...
/**** selective ****/
  ...
  export function selective (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component selective ${Classes ?? ''}"
...
/**** stacked ****/
  ...
  export function stacked (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component stacked ${Classes ?? ''}" ...${RestProps}>
        ${ContentList}
      </>`
    })
  }
...
/**** Outline ****/
  ...
  export function Outline (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component outline ${Classes ?? ''}" ...${RestProps}/>`
    })
  }
...
/**** Spacer ****/
  ...
  export function Spacer (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component spacer ${Classes ?? ''}" ...${RestProps}/>`
    })
  }
...
/**** expandingSpacer ****/
  ...
  export function expandingSpacer (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component expanding-spacer ${Classes ?? ''}" ...${RestProps}/>`
    })
  }
...
/**** horizontalSeparator ****/
  ...
  export function horizontalSeparator (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component horizontal-separator ${Classes ?? ''}" ...${RestProps}/>`
    })
  }
...
/**** verticalSeparator ****/
  ...
  export function verticalSeparator (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component vertical-separator ${Classes ?? ''}" ...${RestProps}/>`
    })
  }
...
/**** TextView ****/
  ...
  export function TextView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component textview ${Classes ?? ''}" ...${RestProps}>${Value ?? ''}</>`
    })
  }
...
/**** HTMLView ****/
  ...
  export function HTMLView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component htmlview ${Classes ?? ''}" ...${RestProps}
  ...
  export function MarkdownView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      const HTMLContents = useMemo(
        () => MarkdownRenderer.paime(Value ?? ''),[Value]
      )

      return html`<div class="sim-component markdownview ${Classes ?? ''}" ...${RestProps}
...
/**** ImageView ****/
  ...
  export type  SIM_ImageScaling  = typeof SIM_ImageScalings[number]
  ...
  export type SIM_ImageAlignment = typeof SIM_ImageAlignments[number]
  ...
  export function ImageView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<img class="sim-component imageview ${Classes ?? ''}" src=${Value ?? ''} style="
...
/**** SVGView ****/
  ...
  export function SVGView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<img class="sim-component svgview ${Classes ?? ''}" src=${DataURL} style="
        object-fit:${ImageScaling ?? 'contain'};
        object-position:${ImageAlignment ?? 'center center'}; ${Style}
      " ...${RestProps}/>`
    })
...
/**** WebView ****/
  ...
  export const SIM_DefaultSandboxPermissions = (
  ...
  export type SIM_ReferrerPolicy = typeof SIM_ReferrerPolicies[number]
  ...
  export function WebView (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<iframe class="sim-component webview ${Classes ?? ''}" src=${Value ?? ''}
...
// modified version from https://gist.github.com/zwinnie/3ed8e7970240962bc29227533c3ae047
  ...
  type SIM_FAIconName = typeof SIM_FAIconNames[number]
  ...
  export function FAIcon (PropSet:Indexable):any {
    return safelyRendered(() => {
      let [
        ...
        optionalTextline('class'),
        optionalValue   ('value',(Value:any) => ValueIsOneOf(Value,SIM_FAIconNames)),
        optionalColor   ('color'),
        optionalBoolean ('active'),
        optionalBoolean ('disabled'),
        optionalFunction('onclick'),
      ...
      return html`<div class="sim-component fa-icon fa ${Value} ${disabled ? 'disabled' : ''} ${active ? 'active' : ''} ${Classes ?? ''}" style="
        color:${Color};
        cursor:${Cursor};
      " onClick=${_onClick} ...${RestProps}/>`
    })
...
/**** Button ****/
  ...
  export function Button (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      if (Value == null) {
        return html`<button class="sim-component button ${Classes ?? ''}" ...${RestProps}>
          ${ContentList}
        </>`
      } else {
        return html`<button class="sim-component button ${Classes ?? ''}" ...${RestProps}
...
/**** Checkbox ****/
  ...
  export function Checkbox (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component checkbox ${actualDisabling ? 'disabled' : ''} ${Classes ?? ''}"
        style=${Style}
      >
        <input type="checkbox"
...
/**** Radiobutton ****/
  ...
  export function Radiobutton (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component radiobutton ${actualDisabling ? 'disabled' : ''} ${Classes ?? ''}"
        style=${Style}
      >
...
/**** Gauge ****/
  ...
  export function Gauge (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component gauge ${Classes ?? ''}" style=${Style}>
        <meter
...
/**** Progressbar ****/
  ...
  export function Progressbar (PropSet:Indexable):any {
    return safelyRendered(() => {
      ...
      return html`<div class="sim-component progressbar ${Classes ?? ''}" style=${Style}>
...
/**** Slider ****/
  ...
  export function Slider (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<div class="sim-component slider ${Classes ?? ''}" style=${Style}>
  ...
  export function TextlineInput (PropSet:Indexable):any {
    ...
    /**** ignore external changes while this control is in use ****/
      ...
      const [ actualValue,actualPlaceholder,actualDisabling ] = (
        ValueIsSpecial(ValueToShow)
        ? [ undefined,ValueToShow === SIM_empty ? Placeholder ?? ValueToShow.Placeholder : ValueToShow.Placeholder,disabled || ValueToShow.disabled ]
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="text" class="sim-component textline-input ${Classes ?? ''}" ref=${ViewRef}
...
/**** PasswordInput ****/
  ...
  export function PasswordInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="password" class="sim-component password-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} minlength=${minLength} maxlength=${maxLength}
        readOnly=${readonly} placeholder=${actualPlaceholder}
...
/**** EMailAddressInput ****/
  ...
  export function EMailAddressInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="email" class="sim-component emailaddress-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} minlength=${minLength} maxlength=${maxLength}
...
/**** PhoneNumberInput ****/
  ...
  export function PhoneNumberInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="tel" class="sim-component phonenumber-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} minlength=${minLength} maxlength=${maxLength}
...
/**** URLInput ****/
  ...
  export function URLInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="url" class="sim-component url-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} minlength=${minLength} maxlength=${maxLength}
        readOnly=${readonly} placeholder=${actualPlaceholder} pattern=${Pattern}
        disabled=${actualDisabling} list=${SuggestionId}
        onInput=${_onInput} onBlur=${_onBlur} ...${RestProps}
...
/**** TimeInput ****/
  ...
  export function TimeInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="time" class="sim-component time-input ${Classes ?? ''}" ref=${ViewRef}
...
/**** DateTimeInput ****/
  ...
  export function DateTimeInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="datetime-local" class="sim-component datetime-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} min=${Minimum} max=${Maximum} step=${withSeconds ? 1 : 60}
        readOnly=${readonly} pattern=${SIM_TimePattern}
        disabled=${actualDisabling}
        onInput=${_onInput} onBlur=${_onBlur} ...${RestProps}
...
/**** DateInput ****/
  ...
  export function DateInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="date" class="sim-component date-input ${Classes ?? ''}" ref=${ViewRef}
...
/**** WeekInput ****/
  ...
  export function WeekInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="week" class="sim-component week-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} min=${Minimum} max=${Maximum}
        readOnly=${readonly} pattern=${SIM_TimePattern}
        disabled=${actualDisabling}
        onInput=${_onInput} onBlur=${_onBlur} ...${RestProps}
...
/**** MonthInput ****/
  ...
  export function MonthInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="month" class="sim-component month-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} min=${Minimum} max=${Maximum}
        readOnly=${readonly} pattern=${SIM_TimePattern}
        disabled=${actualDisabling}
        onInput=${_onInput} onBlur=${_onBlur} ...${RestProps}
...
/**** SearchInput ****/
  ...
  export function SearchInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="search" class="sim-component search-input ${Classes ?? ''}" ref=${ViewRef}
        value=${actualValue} minlength=${minLength} maxlength=${maxLength}
        readOnly=${readonly} placeholder=${actualPlaceholder}
        pattern=${Pattern} spellcheck=${SpellChecking}
        disabled=${actualDisabling} list=${SuggestionId}
...
/**** FileInput ****/
  ...
  export function FileInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<label class="sim-component file-input ${Classes ?? ''}">
        ${actualValue == null
...
/**** ColorInput ****/
  ...
  export function ColorInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<input type="color" class="sim-component color-input ${Classes ?? ''}"
...
/**** DropDown ****/
  ...
  export function DropDown (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<select class="sim-component dropdown ${Classes ?? ''}"
        disabled=${actualDisabling} onInput=${_onInput} ...${RestProps}
...
/**** TextInput ****/
  ...
  export function TextInput (PropSet:Indexable):any {
    ...
    /**** actual rendering ****/
      ...
      return html`<textarea class="sim-component text-input ${Classes ?? ''}"
...
//------------------------------------------------------------------------------
  ...
  export function TabStrip (PropSet:Indexable) {
    ...
    /**** handle clicks ****/
      ...
      const onClick = useCallback((Index:SIM_Ordinal, Event:Event):void => {
        if (disabled) { return consumingEvent(Event) }
    ...
    /**** actual rendering ****/
      ...
      return html`<div class="sim-component tabstrip ${Classes ?? ''}" ...${RestProps}>
...
//    expanded = expanded ?? false
    ...
    /**** actual rendering ****/
      ...
      return html`<div class="sim-component accordion-fold ${Classes ?? ''}">
        <div class="header">
...
//------------------------------------------------------------------------------
  ...
  export type SIM_FlatListItemKey           = string
  export type SIM_KeyOfFlatListItem         = (Item:Indexable, List:Indexable[], Index:SIM_Ordinal) => SIM_FlatListItemKey
  export type SIM_FlatListItemRenderer      = (Item:Indexable, List:Indexable[], Index:SIM_Ordinal, isSelected:boolean, InsertionDirection:''|'before'|'after') => any
  export type SIM_onFlatListItemClick       = (Item:Indexable, List:Indexable[], Index:SIM_Ordinal, Event:PointerEvent) => void
  export type SIM_onFlatListSelectionChange = (selectedItems:Indexable[], List:Indexable[]) => void
  export type SIM_onFlatListItemMove        = (sortedList:Indexable[], movedItemList:Indexable[], TargetItem:Indexable, Direction:'before'|'after') => void
...
/**** Default_KeyOfFlatListItem ****/
  ...
  function Default_KeyOfFlatListItem (
    Item:Indexable, List:Indexable[], Index:SIM_Ordinal
  ):SIM_FlatListItemKey {
    if (KeyMap.has(Item)) {
  ...
  export function FlatListView (PropSet:Indexable) {
    ...
    /**** onClick ****/
      ...
      const onClick = (Event:PointerEvent) => {
        ...
        const Index:SIM_Ordinal = (Event.target as Indexable).Index
    ...
    /**** changeSelection ****/
      ...
      const changeSelection = (
        Item:Indexable, List:Indexable[], Index:SIM_Ordinal, additively:boolean
      ) => {
...
// @ts-ignore TS18047 "Event.dataTransfer" should not be null
    ...
    /**** actual rendering ****/
      ...
      if (List.length === 0) {
        return html`<div class="sim-component flatlistview placeholder ${Classes ?? ''}" ...${RestProps}>
          <div dangerouslySetInnerHTML=${{__html:Placeholder ?? '(empty)'}}/>
        </>`
      } else {
        const { dragging, DropTargetItem, DropMode } = State
        return html`<div class="sim-component flatlistview ${dragging ? 'dragging' : ''} ${Classes ?? ''}"
              onClick=${onClick}
...
//------------------------------------------------------------------------------
  ...
  export type SIM_NestedListItemKey           = string
  export type SIM_KeyOfNestedListItem         = (Item:Indexable ) => SIM_NestedListItemKey
  export type SIM_NestedListItemRenderer      = (Item:Indexable, isSelected:boolean, isPlain:boolean, isExpanded:boolean, InsertionDirection:''|'before'|'after') => any
  export type SIM_onNestedListItemClick       = (Item:Indexable, Event:PointerEvent) => void
  export type SIM_NestedListItemMayBeSelected = (Item:Indexable) => boolean
  export type SIM_onNestedListSelectionChange = (selectedItems:Indexable[]) => void
  export type SIM_NestedListItemMayBeExpanded = (Item:Indexable) => boolean
  export type SIM_onNestedListExpansionChange = (expandedItems:Indexable[]) => void
  export type SIM_NestedListItemMayAccept     = (TargetItem:Indexable, ItemsToMove:Indexable[]) => boolean
  export type SIM_onNestedListItemMove        = (ItemsToMove:Indexable[], TargetItem:Indexable, Direction:'before'|'after') => void

/**** Default_KeyOfNestedListItem ****/

  function Default_KeyOfNestedListItem (Item:Indexable):SIM_NestedListItemKey {
    if (KeyMap.has(Item)) {
      return ''+KeyMap.get(Item)
    } else {
      KeyCounter++
...
// @ts-ignore TS18047 "Event.dataTransfer" should not be null
    ...
    /**** actual rendering ****/
      ...
      if (List.length === 0) {
        return html`<div class="sim-component nestedlistview placeholder ${Classes ?? ''}" ...${RestProps}>
          <div dangerouslySetInnerHTML=${{__html:Placeholder ?? '(empty)'}}/>
        </>`
      } else {
...
/**** executeCallback ****/
  ...
  export function executeCallback (
    Description:SIM_Textline, Callback:Function|undefined, ...ArgList:any[]
  ):any {
